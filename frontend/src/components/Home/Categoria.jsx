    ...
    const Categories = [
        {
            ...
            emoji: '💻',
            title: 'Laptops',
            description: 'Las mejores marcas y modelos para trabajo y gaming'
        },
        {
            id: 'celulares',
            emoji: '📱',
            title: 'Celulares',
            description: 'Ultima tecnologia movil de todas las marcas'
        },
        {
            id: 'componentes',
            emoji: '⚙️',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {Categories.map((category)=>(
                        ...
                        >
                            ...
                            <div className="text-blue-600 font-semibold">Ver mas ➡️</div>
                        </div>
                    ))}
                </div>
            </div>
